...
## recon_weight 1000, kl_weight 100, intermediate_recon, decoder_channel 256
```
/home/ubuntu/anaconda3/envs/pytorch_p36/bin/python main.py \
--mode train \
--train_img_dir /home/ubuntu/data/상의 \
...
--print_every 1 --save_every 10 --total_iters 200 \
--batch_size 64 --lr 1e-4 \
--checkpoint_dir expr/intermediate_recon/recon_1000_kl_100 \
--recon_weight 2000 --kl_weight 500 --resume_iter 140
```